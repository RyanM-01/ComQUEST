        ...
        <div class="overview">
          ...
          <div class="container">
            @foreach ($matkul->babs as $bab)
                <div class="babbox">
                    <div class="bab">
                        <form action="{{ route('admin.bab.update', [$matkul->id, $bab->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <div>
                    <a href="{{ route('admin.quiz.create', $bab->id) }}" class="takequiz-btn" style ="padding:10px; margin-left:400px;" >Add Quiz</a>
                    </div>
                    <div>
